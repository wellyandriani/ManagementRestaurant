  ...
  <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
        ...
        <div class="container navigation">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="<?= base_url() ?>pemilik/c_pasien/">
                </a>
            </div>
    ...
    <section class="intro" id="intro" name="intro">
      ...
      <div align="center">
	  <br>
        <h3>PENGGAJIAN</h3></div> 		  
       <div align="center">
	   <form method="post" action="<?= base_url() ?>pemilik/c_penggajian/search_keyword/">
          <input type="text" name = "keyword" placeholder="Masukkan Id atau nama Karyawan" size="40" required>
        <input type="submit" value="search">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><a href="<?= base_url() ?>pemilik/c_tambahpenggajian/"><button class="glyphicon glyphicon-plus" type="button">TambahGaji</button></a></span>
		</form></div>
		<p>&nbsp </p>
				...
				<thead >
					<tr >
						...
						<th class="text-center" width="220" bgcolor="#40546a">Total Gaji</th>
				...
				<tbody>
					<?php
						...
						foreach ($listPenggajian->result() as $row) {
					...
					<tr>
						...
						<td bgcolor="#FFFFFF" align="center">Rp. <?= number_format($row->total_gaji,0,",",".")?></td>
						<td bgcolor="#FFFFFF" align="center">
							<!-- Akan melakukan update atau delete sesuai dengan id yang diberikan ke controller -->
                            <a  onclick="return konfirmasi()" href="<?= base_url() ?>pemilik/c_penggajian/deletePenggajianDb/<?= $row->id_karyawan ?>"> <input class="input btn-danger" type="submit" value="hapus" /></a>
							 <a href="<?= base_url() ?>pemilik/c_penggajian/detailPenggajian/<?= $row->id_karyawan ?>"><input type="submit" class="input btn-info" value="lihatDetail" /></a>
						</td>
					</tr>
					<?php
						}

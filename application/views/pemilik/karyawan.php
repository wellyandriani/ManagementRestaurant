...
<div id="wrapper">
        ...
        <div class="container navigation">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
			  <ul class="nav navbar-nav">
                <li><a href="<?= base_url() ?>index.php/pemilik/c_menu/">Menu</a></li>
                <li class="active"><a href="<?= base_url() ?>index.php/pemilik/c_karyawan/">Karyawan</a></li>
                <li><a href="<?= base_url() ?>index.php/pemilik/c_penggajian/">Penggajian</a></li>
                <li><a href="<?= base_url() ?>index.php/pemilik/c_penghasilan/">Penghasilan</a></li>
   ...
   <div align="center"> 
   <form method="post" action="<?= base_url() ?>index.php/pemilik/c_karyawan/search_keyword/" >
          <input type="text" name = "keyword" placeholder="Masukkan nama atau Id karyawan" size="40" required ></input>
        <input type="submit" value="search"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?= base_url() ?>index.php/pemilik/c_tambahkaryawan/"><button class="glyphicon glyphicon-plus" type="button">TambahKaryawan</button></a>
</form></div> <p>&nbsp;</p>
				...
				<thead >
					...
					<th class="text-center" width="40" bgcolor="#40546a">No.</th>
						<th class="text-center" width="160" bgcolor="#40546a">Id Karyawan</th>
						<th class="text-center" width="200" bgcolor="#40546a">Nama</th>
                        <th class="text-center" width="170" bgcolor="#40546a">Jenis User</th>
				...
				<tbody>
					...
					<tr>
						...
						<td bgcolor="#FFFFFF" align="center"><?= $row->nama_karyawan?></td>
						<td bgcolor="#FFFFFF" align="center"><?= $row->user?></td>
						<td bgcolor="#FFFFFF" align="center">
						
							<!-- Akan melakukan update atau delete sesuai dengan id yang diberikan ke controller -->
						  <a  onclick="return konfirmasi()" href="<?= base_url() ?>index.php/pemilik/c_karyawan/deleteKaryawanDb/<?= $row->id_karyawan ?>"> <input class="input btn-danger" type="submit" value="hapus" /></a>
						  <a href="<?= base_url() ?>index.php/pemilik/c_karyawan/updateKaryawan/<?= $row->id_karyawan ?>"><input class="input btn-warning" type="submit" value="ubah" /></a>
                        <a href="<?= base_url() ?>index.php/pemilik/c_karyawan/detailKaryawan/<?= $row->id_karyawan ?>"><input type="submit" class="input btn-info" value="lihatDetail" /></a>
						</td>
					</tr>
					<?php
						}

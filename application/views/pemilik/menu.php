  ...
  <nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
    ...
    <section class="intro" id="intro" name="intro">
      ...
      <div align="center">
        <h3 > MENU</h3></div> 		  
       <div align="center">
	   <form method="post" action="<?= base_url() ?>pemilik/c_menu/search_keyword/"> 
          <input type="text" name = "keyword" placeholder="Masukkan nama atau Id menu" size="40" required>
        <input type="submit" value="search">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<span><a href="<?= base_url() ?>pemilik/c_tambahmenu"><button class="glyphicon glyphicon-plus" type="button" >TambahMenu</button></a></span>
		...
		<p>&nbsp </p>
				...
				<thead >
					<tr >
						...
						<th class="text-center" width="180" bgcolor="#40546a">Id Menu</th>
						<th class="text-center" width="200" bgcolor="#40546a">Nama</th>
						<th class="text-center" width="130" bgcolor="#40546a">Kategori</th>
				...
				<tbody>
					...
					<tr>
						...
						<td bgcolor="#FFFFFF" align="center"><?= $row->id_menu ?></td> 
						<td bgcolor="#FFFFFF" align="center"><?= $row->nama_menu?></td>
						<td bgcolor="#FFFFFF" align="center"><?= $row->kategori?></td>
						<td bgcolor="#FFFFFF" align="center">
							<!-- Akan melakukan update atau delete sesuai dengan id yang diberikan ke controller -->
							<a  onclick="return konfirmasi()" href="<?= base_url() ?>pemilik/c_menu/deleteMenuDb/<?= $row->id_menu ?>"> <input class="input btn-danger" type="submit" value="hapus" /></a>
						  <a href="<?= base_url() ?>pemilik/c_menu/updateMenu/<?= $row->id_menu?>"><input class="input btn-warning" type="submit" value="Ubah" /></a>
							<a href="<?= base_url() ?>pemilik/c_menu/detailMenu/<?= $row->id_menu ?>"><input type="submit" class="input btn-info" value="lihatDetail" /></a>
						</td>
					</tr>
					<?php
						}
